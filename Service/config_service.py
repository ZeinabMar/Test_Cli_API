...
config_Service_3 = {'gpon-onu': ["tcont 1 profile test",
                ...
                #              "vlan 12 bridge 1 type service-point-point state enable",
                             ...
                             "registration table reg1 bridge 1 cvlan 116, 220, 221  svlan 16, 20, 21"],
                    'gpon-olt':
                            ["no shutdown",
                            "switchport",
                            "bridge-group 1 spanning-tree enable",
                    ...
                    'ge':
                            ...
                            "switchport QinQ trunk mode S-tagged tag 16,20-21",
                            "speed 1G"]}   
#**********************************************************************************************************
config_Service_4 = {'gpon-onu': ["tcont 1 profile test",
                    ...
                    'total':["bridge 1 protocol provider-rstp-edge", 
                        ...
                        #      "vlan 20 bridge 1 type service-point-point state enable",
                             "registration table reg1 bridge 1 cvlan 116,221,220 svlan 16,21,20"],
                    'gpon-olt':
                            ["no shutdown",
                            "switchport",
                            "bridge-group 1 spanning-tree enable",
                    ...
                    'ge':
                            ...
                            "switchport mode customer-network",
                            "switchport QinQ trunk mode S-tagged tag 16,20-21",
                            "switchport QinQ trunk translation svlan-src 15,14,13 svlan-des 16,21,20"]}   
#***************************************************************************************************************************    
...
config_Service_8 = {'gpon-onu': [
                    ...
                    'gpon-olt1/1':
                            ["no shutdown",
                            "multi-onusrv-cfg onu-srvprofile 1 onu 1",
                            "switchport",
                            "bridge-group 1 spanning-tree enable",
                            "switchport mode trunk",
                            "switchport trunk tag 116"],
