...
config_Service_4 = {'gpon-onu': ["tcont 1 profile test",
                    ...
                    'total':["bridge 1 protocol provider-rstp-edge", 
                        ...
                        #      "vlan 115 bridge 1 type customer state enable",
                             ...
                             "vlan 112 bridge 1 type service-point-point state enable",
                    ...
                    'gpon-olt':
                            ...
                            "bridge-group 1 spanning-tree enable",
                            "switchport mode customer-edge-trunk",
                            "switchport QinQ trunk mode C-tagged tag 115-116,221 egresstag enable",
                            "switchport QinQ registration reg1"
                            ],
                    'ge':
                            ["speed 1G",
                            ...
                            "bridge-group 1 spanning-tree enable", 
                            "switchport mode customer-network",
                            "switchport QinQ trunk mode S-tagged tag 115-116,221",
                            "switchport QinQ trunk translation svlan-src 113,114,112 svlan-des 116,221,220"]}   
#***************************************************************************************************************************    
config_Service_5 = {'gpon-onu': ["tcont 1 profile HSI",
                    ...
                    'ge':
                           ["switchport",
                            ...
                            "switchport trunk tag 220-221"]}                                                                                                                                                                                             
#****************************************************************************************************************************
config_Service_6 = {'gpon-onu1': ["tcont 1 profile test",
	                         "gemport 1 tcont 1",
	                         "service-port 1 gemport 1 user-vlan 220 transparent",
	                         "remote service 1 gem 1 uni veip vlan-mode access pvlan 220 priority 6"],
                     'gpon-onu2': ["tcont 1 profile test",
	                         "gemport 1 tcont 1",
	                         "service-port 1 gemport 1 user-vlan 221 transparent",
	                         "remote service 1 gem 1 uni veip vlan-mode access pvlan 221 priority 7"],     
