...
[Port_L2(1, "no shutdown", result_find=["no shutdown"], grep="shutdown"),
 Port_L2(1, "speed 100G", result_find=["speed 1G"], result_error=["Problem"], grep="speed"),
 Port_L2(1, "max-frame 15000", result_find=["max-frame 1400"], result_error=["Error code: -1625"], grep="max-frame"),
 Port_L2(1, "flowctrl tx", result_find=["flowctrl TX"], grep="flowctrl"),
#  Port_L2(1, "loopback phy", result_find=["loopback mac"],result_error=["Problem"], grep="loopback"),
 Port_L2(1, "duplex half", result_find=["duplex full"],result_error=["Error code: -1625"], grep="duplex"),
 Port_L2(1, "description ", result_find=["description t"], result_error=["Incomplete command"], grep="description")],

 [Port_L2(1, "no shutdown", result_find=["no shutdown"], grep="shutdown"),
 Port_L2(1, "speed 1G", result_find=["speed 1G"], grep="speed"),
 Port_L2(1, "max-frame 1400", result_find=["max-frame 1400"], grep="max-frame"),
 Port_L2(1, "flowctrl both", result_find=["flowctrl Both"], grep="flowctrl"),
#  Port_L2(1, "loopback mac", result_find=["loopback mac"], grep="loopback"),
 Port_L2(1, "duplex full", result_find=["duplex full"], grep="duplex"),
 Port_L2(1, "description t", result_find=["description t"], grep="description")],
]
