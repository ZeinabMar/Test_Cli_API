        ...
        stage('Test') {
            ...
            steps {
                script {
                    ...
                    sh "python3 /home/pr/pr-docker-manager/exec_test.py -u jenkins -n ${TEST_RUN_NAME} -p test_sp5100_cli -r ${params.revision_type} -v ${params.revision_value} -s ${params.test_suit_path}"
                }
            }
        }
    }
